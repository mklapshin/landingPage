...
let a = 0;
  ...
  let numberActiveReviews = 0;
    reviews__btn1.addEventListener('click', function (event) {  
        ...
        reviews_full.style.height = '890px';
        reviews_button_transform.style.display = 'none';
        numberActiveReviews +=1;
    });
    ...
    reviews__btn1_2.addEventListener('click', function (event) {  
        ...
        numberActiveReviews -=1;
        if (numberActiveReviews == 0) {
            reviews_full.style.height = '530px';
            reviews_button_transform.style.display = 'block';
        }
    });
