...
function SimpleAdaptiveSlider(t,i){
    ...
    this._currentIndex=0,this._minOrder=0,this._maxOrder=0,
    ...
    this._config={loop:!0,
        autoplay:!1,
        interval:5e3,
        swipe:!0},i)this._config.hasOwnProperty(e)&&(this._config[e]=i[e]);
